---
{"dg-publish":true,"permalink":"/game-design/genre-dissection/genre-glossary/","dg-note-properties":{}}
---
...
- **[[Game Design/Genre Dissection/Game Genres/Role-playing#Deckbuilder Roguelike\|Role-playing#Deckbuilder Roguelike]]**
	- **Standard Intent-Telegraphed Deckbuilder:** Single-character run-based card drafting featuring deterministic enemy intent displays, node-map pathfinding, and passive relic synergies.
	- **Spatial / Multi-Floor Deckbuilder:** Combines card drafting with tactical unit placement, grid board positioning, or multi-tiered lane defense mechanics.
	- **Dice / Probability Modification Deckbuilder:** Hybridizes card drafting with randomized dice pools, slot manipulation, or active luck-mitigation mechanics.
